# ===============================
# src/vector_db.py  (QDRANT ONLY)
# - No separate config file needed
# - Works in 2 modes automatically:
#   1) SERVER mode (default): connect to http://localhost:6333
#   2) EMBEDDED mode: set QDRANT_MODE=embedded (stores data in ./qdrant_data)
#
# ENV (optional):
#   QDRANT_MODE=server|embedded        (default: server)
#   QDRANT_HOST=localhost             (default: localhost)
#   QDRANT_PORT=6333                  (default: 6333)
#   QDRANT_GRPC_PORT=6334             (default: 6334)
#   QDRANT_TIMEOUT=60                 (default: 60)
#   QDRANT_PREFER_GRPC=false          (default: false)
#   QDRANT_COLLECTION=rag_chunks      (default: rag_chunks)
#   QDRANT_UPSERT_BATCH=256           (default: 256)
#
# Payload indexing:
#   KEYWORD indices : file_id, paper_id, source_type, section_title, run_id, chunking.strategy
#   INTEGER index   : year      ← stored as int, must be queried as int
# ===============================
